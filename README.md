...
1. 소속 학생들이 등록한 스펙, 지원 이력, 취업 후기 데이터를 기반으로 업 회원 기능
...
1. 랜딩
   1. 랜딩페이지
      <img width="2858" height="1436" alt="image" src="https://github.com/user-attachments/assets/88a6b267-41e9-41b7-a4cc-36a745abff32" />
      - 사용자가 서비스에 처음 접속할 때 보게 되는 메인 랜딩 페이지
      - 로그인 버튼 혹은 회원가입 버튼 클릭 가능
2. 회원가입 및 로그인
   - 회원 유형 선택 페이지
      <img width="2852" height="1360" alt="image" src="https://github.com/user-attachments/assets/5dc69811-5f0c-4a1f-b33b-ea3b80772d39" />
      - 개인 회원, 기업 회원, 대학교 교직원 회원 중 어떤 유형으로 가입할지 선택하는 페이지
      - 회원 유형 (개인, 기업, 대학교 교직원) 선택 후 해당하는 유형의 회원가입 페이지로 이동됨
    - 개인 회원가입 페이지
    ...
    5. 대학교 교직원 회원가입 페이지
       ...
       - 가입하기 : 모든 항목을 입력했다면 가입하기 버튼 활성화
    7. 기업 회원가입 페이지
        1. 기업이 가입할 수 있는 회원가입 페이지
        2. 기업 정보: 기업 형태, 사업자등록명, 회사명, 회사 주소, 
        3. 기업 인증 : 사업자등록증명원 발급번호을 통해 인증
        4. 계정 정보 입력 : 아이디, 비밀번호, 비밀번호 확인, 이름
        5. 전화번호 인증 : 전화번호(000-0000-0000 형식) 입력 후 인증번호 입력
        6. 약관 동의 : 모든 약관 동의 체크박스
        7. 가입하기 : 모든 항목을 입력했다면 가입하기 버튼 활성화
    8. 로그인 페이지
        1. 회원 유형 선택: 개인 회원, 기업 회원, 대학교 교직원 회원 탭
        2. 아이디와 비밀번호 입력 후 로그인 버튼 클릭
        3. 성공 시 메인페이지로 이동
        4. 실패 시 오류 메세지가 알림으로 표시
4. 개인 회원 메인
   1. 메인페이지
1. 
